...
test_model = r'D:\AI_task\task2\MySolution\Model\model\ep399.pth'
imgPath=r"D:\AI_task\task2\MySolution\Data\trainData\image88.jpg"
img_w=1920
img_h=1080
cls_num_per_lane = 18
...
if __name__ == "__main__":
    ...
    net = parsingNet(pretrained=False, use_aux=False,
                     cls_dim = (griding_num+1,cls_num_per_lane, num_lanes)).cuda()  # we dont need auxiliary segmentation in testing
